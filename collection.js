...
var _events = require('bookshelf/lib/base/events');

var _events2 = _interopRequireDefault(_events);

var _promise = require('bookshelf/lib/base/promise');

var _promise2 = _interopRequireDefault(_promise);

var _model = require('bookshelf/lib/base/model');

var _model2 = _interopRequireDefault(_model);

var _extend = require('bookshelf/lib/extend');
...
CollectionBase.prototype.set = function (models, options) {
    ...
    for (i = 0, l = models.length; i < l; i++) {
        ...
        if (existing) {
            ...
            const __key = Buffer.isBuffer(model.id) ? model.id.toString('hex') : model.id;
            if (model.id != null) this._byId[__key] = model;
        }
...
CollectionBase.prototype.remove = function (models, options) {
    ...
    for (var i = 0; i < models.length; i++) {
        ...
        if (!model) continue;
        delete this._byId[Buffer.isBuffer(model.id) ? model.id.toString('hex') : model.id];
